...
namespace Drupal\abc_regions\Plugin\Block;
 ...
 * @Block(
 *   id = "child_regions",
 *   admin_label = @Translation("Shows child regions of current term in tree"),
 *   category = @Translation("Child Regions"),
 * )
 */
class ChildRegions extends BlockBase {

  /**
   * {@inheritdoc}
   */
  public function build() {
    // Find current TID from URL Args
    
    
    
    
    $list = "<div class='child-regions'>";
    $list .= "<ul>";
    ...
    /** 
     * Find all child terms of current TID term
     */
