...
namespace Drupal\webcurl_custom\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'button_link_separate' formatter.
 *
 ...
 *
 * @FieldFormatter(
 *   id = "button_link_separate",
 *   label = @Translation("Separate Button link text and URL"),
 *   field_types = {
 *     "button_link"
 *   }
 * )
 */
class ButtonLinkSeparateFormatter extends LinkFormatter {
