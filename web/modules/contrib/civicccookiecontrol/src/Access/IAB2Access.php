...
/**
 * Service that checks access to IAB1 binded to _iab2_access_check.
 */
class IAB2Access extends CookieControlAccess implements AccessInterface {
  /**
  ...
  public function access(AccountInterface $account) {
    return AccessResult::allowedIf(
          ...
          $this->checkApiKey() &&
          ($this->cccSettingsConfig->get('civiccookiecontrol_api_key_version') == 9)
      );
  }
