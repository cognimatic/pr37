 ...
 */
class ExcludedCountryListBuilder extends ConfigEntityListBuilder {
  ...
  public function buildHeader() {
    ...
    $header['excludedCountryIsoCode'] = $this->t('Excluded Country (ISO Code)');
  ...
  public function buildRow(EntityInterface $entity) {
    $row['id'] = $entity->id();
    $row['excludedCountryIsoCode'] = $entity->label();
