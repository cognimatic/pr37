...
class CheckDisableForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to disable the production check %check?', ['%check' => $this->entity->label()]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Disabled production check %check.', ['%check' => $this->entity->label()]));
