...
class Contact extends ProdCheckBase {
  ...
  public function init() {
    $forms = \Drupal::entityTypeManager()->getStorage('contact_form')->getQuery()->condition('status', 1)->execute();
  ...
  public function failMessages() {
    return [
      'value' => $this->t('Dangerous contact e-mail addresses are %categories', ['%categories' => implode(',', $this->matches)]),
